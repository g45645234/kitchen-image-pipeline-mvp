...
6. Download candidates that should be reviewed with `POST /api/candidates/{candidate_id}/download`. Real AI reviewer jobs require `storage_key_original`; `/api/candidates/{candidate_id}/reviews/run` rejects URL-only candidates.
